...
_G[attachCheckbox:GetName() .. "Text"]:SetText("Anchor to Player Frame")
...
local scaleSlider = CreateSlider("DFMScaleSlider", panel, 0.5, 2.0, 0.1, "UI Scale", "scale", function(val)
